...
include "checksession.php";
  ...
  $errorPage = $noticeboard = $spareParts = $groupDetails = $techDetails = $supportDesk = $help =  $viewECO = "";
  ...
  <div class="subnavbar-inner">
    ...
    <div class="container">
      ...
      <ul class="mainnav">
        ...
        <li <?=$spareParts?>><a href="index.php?page=spareParts"><i class="icon-user"></i><span>Spare Parts</span> </a> </li>

        <li <?=$groupDetails?>><a href="index.php?page=groupDetails"><i class="icon-user"></i><span>Product Details</span> </a> </li>

        <li <?=$viewECO?>><a href="index.php?page=viewECO"><i class="icon-user"></i><span>View ECO</span> </a> </li>
