                        ...
                        ?>
                            <tr>
                              ...
                              <td style="vertical-align:top;"><ul>
                                    <?php
                                      $rows1 = selectrec("`spare_id`,`url`","groups_details","active=1 and changed=1 and group_id=".$row[0]);

                                      foreach($rows1 as $row1)
                                        echo "<li><a href='".$row1[1]."' target='_blank'>".singlefield("spare_name","spares","spare_id=".$row1[0])."</a></li>";
                                    ?>
                                  </ul>
                              </td>
                              <td style="vertical-align:top;"><ul>
