...
{	
  ...
  // variables
    ...
    this.TRANSITION_SPEED_RATIO = 5;
    this.FREEZE_CAMERA_MODE = false;
...
function IPCApi__nextTransition() {
  if(this.is_loaded) {
    if(this._transitions.length > 0) {
      ...
      this.control_script.Fields.Item('set_speed_ratio').Value = this.TRANSITION_SPEED_RATIO;
