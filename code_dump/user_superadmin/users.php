          ...
          <div class="widget widget-nopad">
            <div class="widget-header"> <i class="icon-list-alt"></i>
              ...
              <button class="btn btn-primary pull-right btn-right" data-toggle="modal" data-target=".bs-example-modal-sm">Add Users</button>
            </div>
            ...
            <div class="modal fade bs-example-modal-sm" tabindex="-1" role="dialog" aria-labelledby="mySmallModalLabel" aria-hidden="true">
              <div class="modal-dialog modal-sm">
                <div class="modal-content">
                  ...
                  <form action="#" method="post" id="addUserForm" onsubmit="return submitNewUser(1)">
                        <input type="hidden" name="action" value="addUserfromAdmin"/>
                        <h1>Add User</h1>      
                        <p class="small">Note: You are a superadmin and you can add only Admins</p>
                        <p class="alert"></p>
                        ...
                        <div class="login-actions">
                          ...
                          <input type="submit"  class="button btn btn-primary btn-large" id="registerBtn" value="Register">
